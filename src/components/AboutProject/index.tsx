        ...
        <section className={style.body}>
            ...
            <div className={style.content}>
                <div className={style.contentText}>
                    ...
                    <p className={style.contentDesc}>And finally, I would like to pay attention to the people who not only inspired me, but also supported me. Special thanks to IvanVikVik, Yura and ePinki!</p>
                </div>
            </div>
        </section>
    );
